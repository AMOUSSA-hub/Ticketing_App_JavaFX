...
public class TicketPersistenceApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //initialiser le tableau d'affichage des tickets déjà créés
        ...
        //Afficher les détails d'un ticket sélectionné dans le formulaire
        ...
        //Exporter les tickets vers un fichier CSV
